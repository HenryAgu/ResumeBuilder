      ...
      <main className="w-full max-w-[210mm] h-fit mx-auto print:w-full print:max-w-none print:shadow-none print:p-0 print:my-0 shadow-xl flex flex-col p-10 py-20 my-20">
        ...
        <section className="mt-5 flex flex-col items-center justify-center text-center gap-y-0.5">
          ...
          <p className="text-sm text-black font-light text-left pt-2">
            ...
            nihil exercitationem, asperiores cupiditate deserunt vero expedita
            ...
            vero expedita quo nemo dolores! Lorem ipsum dolor sit amet
            consectetur adipisicing elit. Odit amet nihil exercitationem,
            asperiores cupiditate deserunt vero expedita quo nemo dolores! Lorem
            ipsum dolor sit amet consectetur adipisicing elit. Odit amet nihil
            exercitationem, asperiores cupiditate deserunt vero expedita quo
            nemo dolores!
          </p>
        </section>
              ...
              <div className="basis-[80%] flex flex-col">
                ...
                <div className="mt-1">
                  <span className="text-sm">
                    ...
                    Esse ut dolorem provident possimus ducimus.
                  </span>
